    ...
    <div class="menu-bar1">
       <div class="dropdown ">
        ...
        <div class ="container"> 
            ...
            <div class="row my-5 py-5 ps-5  " >
                <table class="table table-borderless" >
                        ...
                        <?php
                         ...
                         global $conn;
                         $ip = getIPAddress();
                         $select_query = "select * from `favorites` where `ip_address`= '$ip'";
                         ...
                         if($result_count > 0){
                            ...
                            <tr >
                               <th scope='col' class='text-center'></th>
                                <th scope='col' colspan='2' class='ps-5'>Products</th>
                        ...
                        <tbody class ='border-top'>
                         ...
                         while($row=mysqli_fetch_array($result)){
                             ...
                             while($row_product_price=mysqli_fetch_array($result_product)){
                                 ...
                                 <td class="text-center p-5 fw-bold text-danger">
                                    <?php 
                                    if($prd_quantity > 0) {
                                        $prd_quantity="IN STOCK";
                                    }else
                                    {
                                        $prd_quantity="OUT OF STOCK";
                                    }
                                    echo $prd_quantity;
                                 
                                    ?></td>

                                 <td class='text-center pt-5 px-2'><a href="favorites.php?cart_id=<?php echo$prd_ID;?>" class = "btn btn-dark fw-bold">Add to Cart</a></td>
                     ...
                     <?php
                            ...
                            echo "<h2 class = 'text-center text-black-50'> Your  is empty </h2>";
                         }
         ...
         <div class ="row" >
            <div class ="col-lg-12 border-top ms-5" style="height: 150px;">
                <div class="container m-5 ps-5">
                    <form action="" method="post">
                        <input type="checkbox" name="select" value="" id="">
                        <label for="select" class = "fw-bold">Select all</label>
                        <a href="" class = "btn fw-bold">Delete</a>
                        <a href="" class = "btn fw-bold">Add yo Cart</a>
                    </form>
