   ...
   <!--search and categories -->
    ...
    <div class="collapse navbar-collapse show navbar-brand ms-5" id="navbarLight">
      <ul class="navbar-nav me-auto mb-2 mb-xl-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="help-and-sopport.php" >Help & support</a>
        </li>
      </ul>
 ...
 <!--second nav bar -->
    ...
    <div class = "row">
        <div class ="col-md-8" aria-hidden="true">
            <div class = "border placeholder m-4 " style="width: 900px; height: 500px;">
            </div>
           

        </div>
         <div class="col-md-4">
                <div class="border mt-4 rounded-3" style="width: 407px; height: 495px;">
                <div class = "border-bottom" style="height: 50px;" >
                <div class="d-flex justify-content-between" aria-hidden="true">
                    <div class = "placeholder rounded-circle m-2"  style="width: 30px; height: 30px;">

                    </div>
                    <div class= "mt-2 me-3">
                        <a href="index.php" class ="text-center"><i class="fa-solid fa-x" style="color: #000000;"></i></a>
                    </div>
                </div>
                </div>
                <div class ="d-flex justify-content-between mt-2 px-3 border-bottom">
                    <div aria-hidden="true">
                        <p class ="placeholder"> ₱330,000.00 </p>
                        <p class ="text-black-50">Current Bid</p>
                    </div>
                    <div aria-hidden="true">
                        <p class ="placeholder"> 30m 24s </p>
                        <p class ="text-black-50">Auction Ends</p>
                    </div>
                    
                </div>
                <div class ="row border-bottom mt-2 m-0">
                    <p class = "fw-bold col-md-5">Bidders</p>
                    <p class = "text-black-50 col-md-7">Starting Bid: ₱300,000.00</p>
                </div>
                <div style="height:230px;" >

                </div>
                <div>
                    <div class ="row m-2 border rounded shadow">
                        <input type="text" class ="col-md-6 border-0" value="Type your message here..." style="width: 320px; height: 47.559px;">
                        <i class="col-md-2 fa-regular fa-paper-plane pt-3 pe-3"  style="color: #000000;"></i>
                    </div>
                </div>
