...
<nav class="navbar navbar-expand-xl " >
  <div class="container-fluid m-3">
   ...
   <!--search and categories -->
    <form action = "" method ="Get" class="input-group w-50 border  rounded navbar-brand ms-5"  >
 ...
 <!--second nav bar -->
        ...
        <div class = "menu-bar1-2">
            ...
            <?php
                ...
                if (!isset($_SESSION['email'])){
                    ...
                    echo '<li> <a href="add_to_cart.php"><i class="fa-solid fa-cart-shopping" style="color: #fcfcfc;"></i> Cart </a></li>';
                }else{
    ...
    <div class = "row ms-3">
        ...
        //show product using search function
           search_product();
